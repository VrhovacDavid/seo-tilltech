  ...
  <section
    ...
    <div class="pt-32 pb-12 md:pt-40 md:pb-20">
      ...
      <div class="px-4 sm:px-6">
        <div class="max-w-3xl mx-auto">
          <div class="text-center pb-12 md:pb-16">
            <h1
              class="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
              Ihre
              <em class="italic relative inline-flex justify-center items-center text-zinc-900">
                SEO-Agentur
                <svg class="absolute fill-zinc-300 w-[calc(100%+1rem)] -z-10" xmlns="http://www.w3.org/2000/svg"
              ...
              in der Schweiz für langrifstigen Erfolg
            </h1>
            <p class="text-lg text-zinc-500 mb-8">
             Wir steigern Ihre Google Rankings und bringen
              mehr qualifizierten Traffic auf Ihre Website. Profitieren Sie von unserer Expertise in SEO für KMU,
              Grossunternehmen, E-Commerce und SaaS.
            </p>
            <div
      ...
      <div
        ...
        <img class="rounded-lg shadow-2xl" src="/images/SEO-Hero.webp" width="1104" height="620" alt="Hero">
      </div>
