    ...
    <div class="py-12 md:py-20">
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="relative max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <div
            class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-xl shadow-md mb-8 relative before:absolute before:-top-12 before:w-52 before:h-52 before:bg-gray-900 before:opacity-[.08] before:rounded-full before:blur-3xl before:-z-10">
            <img src="/images/logo-02.png" width="60" height="60" alt="Logo">
          </div>
          <h2 class="font-inter-tight text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Bereit, die erste Seite von Google zu
            <em class="relative not-italic inline-flex justify-center items-end">
              dominieren?
              <svg class="absolute fill-violet-200 w-[calc(100%+1rem)] -z-10" xmlns="http://www.w3.org/2000/svg"
                width="120" height="10" viewBox="0 0 120 10" aria-hidden="true" preserveAspectRatio="none">
                <path
          ...
          <p class="text-lg text-gray-500 mb-8">Unser Team aus SEO-Experten steht bereit, Ihnen zu helfen. Entdecken Sie
            Ihr SEO-Potenzial in einem kostenlosen Erstgespräch!</p>
          <div
            ...
            <div>
              <a class="btn text-gray-600 bg-white hover:text-gray-900 w-full shadow" href="/#pricing">Angebot</a>
            </div>
          </div>
        </div>
        ...
        <div class="text-center">
          <ul
            class="inline-flex flex-wrap items-center justify-center -m-2 [mask-image:linear-gradient(to_right,transparent_8px,_theme(colors.white/.7)_64px,_theme(colors.white)_50%,_theme(colors.white/.7)_calc(100%-64px),_transparent_calc(100%-8px))]">
            <li
              class="m-2 p-4 relative rounded-lg border border-transparent [background:linear-gradient(theme(colors.zinc.50),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box]">
              <svg class="fill-zinc-400" xmlns="http://www.w3.org/2000/svg" width="40" height="40" aria-label="Adobe">
                <path
                  d="m21.966 31-1.69-4.231h-4.154l3.892-9.037L25.676 31h-3.71Zm-5.082-21H8v21l8.884-21ZM32 10h-8.884L32 31V10Z" />
              </svg>
            </li>
            <li
              class="m-2 p-4 relative rounded-lg border border-transparent [background:linear-gradient(theme(colors.zinc.50),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box]">
              <svg class="fill-zinc-400" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                aria-label="Unsplash">
            ...
            <li
              ...
              <svg class="fill-zinc-400" xmlns="http://www.w3.org/2000/svg" width="40" height="40" aria-label="Windows">
                <path
                  d="m8 11.408 9.808-1.335.004 9.46-9.803.056L8 11.41Zm9.803 9.215.008 9.47-9.803-1.348-.001-8.185 9.796.063Zm1.19-10.725L31.996 8v11.413l-13.005.103V9.898ZM32 20.712l-.003 11.362-13.005-1.835-.018-9.548L32 20.712Z" />
              </svg>
            </li>
            <li
              class="m-2 p-4 relative rounded-lg border border-transparent [background:linear-gradient(theme(colors.zinc.50),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box]">
